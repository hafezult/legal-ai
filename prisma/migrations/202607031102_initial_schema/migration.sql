...
ALTER TABLE "Conversation"
    ADD CONSTRAINT "Conversation_matterId_fkey"
    FOREIGN KEY ("matterId") REFERENCES "Matter"("id")
    ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "Document"
    ADD CONSTRAINT "Document_matterId_fkey"
    FOREIGN KEY ("matterId") REFERENCES "Matter"("id")
    ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "DocumentChunk"
    ADD CONSTRAINT "DocumentChunk_matterId_fkey"
    FOREIGN KEY ("matterId") REFERENCES "Matter"("id")
    ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "ResearchSession"
    ADD CONSTRAINT "ResearchSession_matterId_fkey"
    FOREIGN KEY ("matterId") REFERENCES "Matter"("id")
    ON DELETE CASCADE ON UPDATE CASCADE;
