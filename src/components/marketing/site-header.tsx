...
export function SiteHeader({ className }: { className?: string }) {
  return (
    ...
    >
      <div
        className="relative isolate mx-auto flex max-w-6xl items-center justify-between rounded-[var(--aether-radius-pill)] border border-white/[0.12] bg-zinc-950/92 px-4 py-2 pl-5 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.65),inset_0_1px_0_0_rgba(255,255,255,0.06)] backdrop-blur-xl md:px-5 md:py-2.5"
        style={{
