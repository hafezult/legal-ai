...
describe("redactDraftOnRevocation", () => {
  it("clears draft identity, matter title, instruction, content, and source chunks on revocation", () => {
    const redacted = redactDraftOnRevocation({
      draftId: "draft_1",
      title: "Advice note",
      matterTitle: "Acme privilege review",
    ...
    assert.equal(redacted.matterTitle, "")
