...
describe("indexing secret helpers", () => {
  it("rejects empty, short, placeholder, and low-entropy secrets", () => {
    ...
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-90ef-02f77eabad00dc163eb44fff63faa5826644dce0!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-14f6-b70669af20f6eb1633e1f972c692136e656e1902!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-0db9-f766279ac16af1cada7a859413da9bb9!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-39f1-b8704a567fda699a697273048e0cfc90!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-63ca-35b49ce4c9bfd7c4a9e3e9fd0a14bf5a!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-5329-ac12eb2e8880d5133361bae2abb1de0e!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-4d3c-616919bacc32bcc4add0a5d7e295b5bc!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-289d-1a967323ef0acfee52b55ac6130e4a329c72b26e0cd0b74d!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-d054-344b1472613a3073d3c3f9ba06d6b9bbbaeaa23d!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-e669-1b87ac9531033b0b5b4cff7e7f4e74dfbf96e523!"
      ),
      false
    )
    assert.equal(
      isIndexingSecretStrong(
        "aether-ci-validate-94c3-4aad9dd64f5433a45166915b34ffae326c883cefb174c313!"
      ),
      false
    )
